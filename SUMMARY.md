...
| **LRB v0.2.3** | **R@1 V<N<J preserved across 4 model families × 4 scale points** (12.5× scale span); S3 publication V/N/J = 0.566 / 0.827 / **0.984** (S3.2); LLM-grounded at N=1000 JAMES 0.989 / 0.991 / 0.893 / 0.990 across 4 rerankers, J − N +0.139 … +0.178; J − N gap > +0.10 throughout — [`papers/lrb-preprint/main.pdf`](papers/lrb-preprint/main.pdf) |
...
- Current release: **v0.6.1** (tagged 2026-09-10) — the first published artifact since v0.4.4, carrying all 282 previously untagged PRs (`#831`–`#1112`). **No DOI**: v0.4.4's [`10.5281/zenodo.20652679`](https://doi.org/10.5281/zenodo.20652679) remains the newest *cited* release, and issuing one for v0.6.1 is an open operator decision. `v0.5` was never tagged in its own right. Narrative: `docs/release_notes_v0.6.1.md`.
