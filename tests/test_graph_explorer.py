...
# [W2 2026-05-10] ReasoningOverlayTests + CssAnimationTests (qr-* keyframes)
# 제거 — query-reasoning-overlay 가 graph 페이지에서 사라졌음. 질문 인터페이스
# 가 /chat 으로 이관됐으므로 reasoning overlay 도 chat 페이지에서만.
