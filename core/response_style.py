...
2026-07-01 module-size split (CLAUDE.md rule #5): the StylePreset
dataclass and the three preset definitions (NATURAL / TERSE / DETAILED)
moved to ``core/response_style_presets.py`` when this file crossed the
20 KB cap. They are re-exported here — every existing import site
(``from core.response_style import NATURAL_PRESET`` …) keeps working
unchanged.
"""
...
from core.response_style_presets import (  # noqa: F401 — re-export surface
    DETAILED_PRESET,
    NATURAL_PRESET,
    StylePreset,
    TERSE_PRESET,
