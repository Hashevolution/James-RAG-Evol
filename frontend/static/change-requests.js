...
(function () {
  ...
  function _renderArbiterSlot(cr) {
    ...
    slot.innerHTML = [
      ...
      '</button>',
      '</div>',
      '<div class="d-none mt-8 p-8-10 bg-surface br-6 fs-11 lh-16 c-text-soft font-ui u-20d05c21" id="' + explanationId + '"',
      '>',
      escHtml(explanation),
      '</div>',
    ].join('');
  ...
  function _renderActionsSlot(cr) {
    ...
    slot.innerHTML = [
      '<div class="d-flex gap-8 items-center w-full flex-wrap">',
      '<input class="flex-1 p-7-10 bg-bg bd-1 br-6 c-text fs-12 font-mono u-4a93029a" id="cr-reviewer-input" type="text"',
      ' value="' + escHtml(hint) + '"',
      ' placeholder="reviewer username"',
      ' aria-label="Reviewer username"',
      '>',
      '<button class="btn btn-approve fs-12 br-6 cursor-pointer fw-600 font-mono u-428449ff"',
      ...
      'Approve',
      '</button>',
      '<button class="btn btn-reject fs-12 br-6 cursor-pointer fw-600 font-mono u-2f275d5d"',
      ...
      '</button>',
      '</div>',
      '<div class="mt-8 fs-11 lh-15 font-mono c-muted u-55858526" id="cr-action-status"',
