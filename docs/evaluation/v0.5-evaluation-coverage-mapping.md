...
|---|---|---|---|---|
| **Recall@K** | Headline | `eval/external/lrb/scorer.py::_recall_at_k` | LRB v0.2.3 R@1 / R@5 / R@10; S3 publication R@1 V/N/J = 0.566 / 0.827 / **0.984** (S3.2) | LRB measures *temporal* retrieval — Recall@K against per-T gold supporting docs is the natural axis. R@1 is the V<N<J gap structure; R@5/R@10 stay near-identical (the gap is at top-1, not in top-5 set inclusion) |
