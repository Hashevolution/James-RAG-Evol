...
|---|:---|:---:|:---:|:---:|:---:|:---:|
| **Recall@K** (general IR) | ✅ LRB R@1 = 0.566 / 0.827 / **0.984** (V/N/J) on S3 publication N=1000 (S3.2) | not headlined | not headlined | not verified in current 2.x docs (HotpotQA-style retrieval evals are common in Haystack 1.x tutorials; not confirmed as 2.x headline) | not headlined | not headlined |
