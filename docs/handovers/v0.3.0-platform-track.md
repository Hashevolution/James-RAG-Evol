...
| **CC-R** Claude Code Reasoner | 외부 LLM (Claude Code CLI) 를 Domain Specialist backend 로 + 정규화 트레이스 자산화 (live + historical) → 메타-도그푸딩 코퍼스 | `docs/handovers/v0.3.x-claude-code-reasoner-track.md` | 🟢 **active (2026-05-15)** — 6단 슬라이스 대기 |
