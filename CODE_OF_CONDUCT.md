...
- **Private security advisory**: https://github.com/Hashevolution/James-RAG-Evol/security/advisories/new
  (use this for any sensitive report; the advisory channel is private)
- **GitHub issue**: open an issue tagged `conduct` for non-sensitive reports
