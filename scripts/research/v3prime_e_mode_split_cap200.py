...
# V3'.e-cap200 variant (2026-05-29). Test hidden reasoning floor at
# the more aggressive cap=200 (matches V3'.a query_rewriter's original
# cap) to check whether the "cap full + visible 0" signature appears
# in the other 6 models when pushed harder. gemma4:e4b already showed
# this at cap=400 (10/10 hit cap with median visible bytes 140).
# Cross-family question: do the other 6 models hit cap=200, or do
# they still emit visible output within their natural 50-95 token
# range?
CAP_DEFAULT = 200
CAP_LIFTED = 4096
